...
//    private static final String IMAGE_DIRECTOR_FRONTEND = "D:\\AngularSpringBootTutorials\\InventoryProject\\ims-angular-frontend\\public\\products\\";

    @Value("${product.images.path}")//this has been set to application.properties
    ...
    private String saveImageToFrontendPublicFolder(MultipartFile imageFile){
        ...
        File directory = new File(imageDirectory);//image directory for frontend
        ...
        String imagePath = imageDirectory + uniqueFileName;//image directory for frontend
